local colors = {
        black = { '#17191e', '#0e1013', '#151820', '#0c0e15', '#191a1c', '#101012' },
          -- change
          bg0 = { '#293329', '#1f2329', '#242b38', '#1a212e', '#2c2d30', '#232326' },
          -- change
          bg1 = { '#3e473e', '#3e473e', '#3e473e', '#3e473e', '#3e473e', '#3e473e' },
          bg2 = { '#4d525c', '#30363f', '#343e4f', '#283347', '#3e4045', '#35363b' },
          bg3 = { '#3b3f4c', '#323641', '#363c51', '#2a324a', '#404247', '#37383d' },
         bg_d = { '#21252b', '#181b20', '#1e242e', '#141b24', '#242628', '#1b1c1e' },
         -- change
      bg_blue = { '#738f54', '#738f54', '#738f54', '#738f54', '#738f54', '#738f54' },
    bg_yellow = { '#ebd09c', '#e8c88c', '#f0d197', '#f2cc81', '#e6cfa1', '#e2c792' },
       ...
       yellow = { '#e5c07b', '#e2b86b', '#ebc275', '#efbd5d', '#dfbe81', '#dbb671' },
         ...
         grey = { '#6a6f7a', '#535965', '#546178', '#455574', '#646568', '#5a5b5e' },
